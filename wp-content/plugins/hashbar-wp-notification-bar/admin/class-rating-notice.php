...
if ( ! class_exists( 'Hashbar_Rating_Notice' ) ) {
    class Hashbar_Rating_Notice {
        ...
        public function hashbar_rating_maybe_later() {
            ...
            if ( ! wp_verify_nonce( $_POST['nonce'], 'hashbar-plugin-notice-nonce')  || ! current_user_can( 'manage_options' ) ) {
            exit;
            }
        ...
        public function rating_notice_content() {
            if ( is_admin() ) {
                echo '<div class="notice hashbar-rating-notice is-dismissible" style="border-left-color: #2271b1!important; display: flex; align-items: center;">
                            ...
                            <div>
                                <h3>Thank you for choosing '. esc_html($this->plugin_name) .' to show notifications to your audience!</h3>
                                ...
                                <p>
                                    <a href="https://wordpress.org/support/plugin/'. esc_attr($this->plugin_slug) .'/reviews/?filter=5#new-post" target="_blank" class="hashbar-you-deserve-it button button-primary">OK, you deserve it!</a>
